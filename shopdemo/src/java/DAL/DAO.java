...
public class DAO {
	...
	public List<product> getallProduct() {
		...
		String sql = "select * from\n"
			  + "products_HE160075 inner join Collections_HE160075\n"
			  + "on products_HE160075.collectionID = Collections_HE160075.collectionID";
		try {
	...
	public void insertProduct(String id, String name, String des, String size, int price, int stock, String image, String category, String collection) {
		String sql = "insert into products_HE160075\n"
			  + "values(?,?,?,?,?,?,?,?,?)";
		try {
			con = new DBContext().getConnection();
			ps = con.prepareStatement(sql);
	...
	public void updateProduct(String id, String name, String des, String size, int price, int stock, String image, String category, String collection) {
		String sql = "update products_HE160075 set\n"
	...
	public void deleteProduct(String productID) {
		String sql = "delete from products_HE160075 where productID like ?";
		try {
			con = new DBContext().getConnection();
			ps = con.prepareStatement(sql);
	...
	public List<category> getallCategory() {
		...
		String sql = "select * from categories_HE160075";
		try {
			con = new DBContext().getConnection();
			ps = con.prepareStatement(sql);
			rs = ps.executeQuery();
	...
	public void insertCategory(String id, String name, String des) {
		String sql = "insert into categories_HE160075\n"
			  + "values(?,?,?)";
		try {
			con = new DBContext().getConnection();
			ps = con.prepareStatement(sql);
	...
	public void deleteCategory(String catID) {
		String sql = "delete from Categories_HE160075 where catID like ?";
		try {
			con = new DBContext().getConnection();
			ps = con.prepareStatement(sql);
	...
	public List<collection> getallCollection() {
		...
		String sql = "select * from Collections_HE160075";
		try {
			con = new DBContext().getConnection();
			ps = con.prepareStatement(sql);
			rs = ps.executeQuery();
	...
	public void insertCollection(String id, String name, int discount, String image) {
		String sql = "insert into collections_HE160075\n"
			  + "values(?,?,?,?)";
		try {
			con = new DBContext().getConnection();
			ps = con.prepareStatement(sql);
	...
	public void removeCollection(String colID) {
		String sql = "update products_HE160075\n"
	...
	public void deleteCollection(String colID) {
		String sql = "delete from Collections_HE160075 where collectionID like ?";
		try {
			con = new DBContext().getConnection();
			ps = con.prepareStatement(sql);
			ps.setString(1, colID);
	...
	public List<account> getallAccount() {
		...
		String sql = "select * from Accounts_HE160075 where [status] = 1";
		try {
			con = new DBContext().getConnection();
			ps = con.prepareStatement(sql);
			rs = ps.executeQuery();
	...
	public void insertAccount(String username, String email, String password, String quiz, String answer) {
		...
		String sql = "insert into Accounts_HE160075 (Username,Email,[Password],SecurityQuiz,SecurityAnswer,Role,Status)\n"
			  + "values(?,?,?,?,?,?,?)";
		try {
			con = new DBContext().getConnection();
			ps = con.prepareStatement(sql);
	...
	public void updateAccount(String email, String name, String phone, String city, String district, String address) {
		String sql = "update Accounts_HE160075\n"
	...
	public void deleteacc(String email) {
		String sql = "delete from accounts_HE160075 where Email like ?";
		try {
			con = new DBContext().getConnection();
			ps = con.prepareStatement(sql);
	...
	public void addOrder(account cus, cart cart) {
		...
		String address = "demo";
		try {
			String sql = "insert into [Orders_HE160075] values(?, ?, ?, ?)";
			con = new DBContext().getConnection();
			ps = con.prepareStatement(sql);
			ps.setString(1, date);
			...
			String sql2 = "Select top 1 OrderID from [Orders_HE160075] order by OrderID desc";
			PreparedStatement ps2 = con.prepareStatement(sql2);
			rs = ps2.executeQuery();
			if (rs.next()) {
				int orderID = rs.getInt(1);
				for (item i : cart.getItems()) {
					String sql3 = "Insert into OrderDetails_HE160075 values(?, ?, ?, ?)";
			...
			String sql4 = "update products_HE160075 set stock = stock - ? where productID like ?";
